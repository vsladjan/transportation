...
__decorate([
    (0, core_1.ManyToOne)({ entity: () => Cityarea_1.Cityarea, fieldName: 'CityAreaId', cascade: [], index: 'fk_Station_CityArea1_idx' }),
...
__decorate([
    (0, core_1.Property)({ fieldName: 'Location', length: 45, nullable: true }),
    __metadata("design:type", String)
